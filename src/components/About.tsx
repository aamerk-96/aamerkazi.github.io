    ...
    <div className="container">
      ...
      <div className="card">
        <p className="fp-desc muted" style={{ margin: 0 }}>
          I work at the intersection of physics-based simulation and applied machine learning. My PhD focused on nonlinear finite element modeling of manufacturing processes &mdash; building high-fidelity ABAQUS models with experimental validation under U.S. DOE and Honeywell programs. Today, at Align Technology, I ship production machine learning models for orthodontic treatment planning serving millions of patients annually under FDA regulatory oversight. I&apos;m most interested in problems where domain knowledge changes how a model should be built &mdash; physics-informed features, geometric priors, constraint-aware optimization.
        </p>
      </div>
